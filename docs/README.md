...
> **Please Note:** When a commit is pushed to the `docs/` directory, it triggers a [github actions workflow](https://github.com/OpenOmics/microbe-count/actions) to build the static-site and push it to the gh-pages branch.
