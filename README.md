 ...
 * [<code>microbe-count <b>run</b></code>](https://openomics.github.io/microbe-count/usage/run/): Run the microbe-count pipeline with your input files.
